...
router.get('/:id', supervisorController.get_a_supervisor);
...
router.get('/students/:supervisorId', supervisorController.get_student_from_a_supervisor);

//delete a student
router.delete('/student/:studentId',supervisorController.delete_student_with_id);
